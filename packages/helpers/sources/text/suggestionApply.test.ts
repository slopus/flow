...
import { suggestionApply } from './suggestionApply.js';
...
describe('suggestionApply', () => {
    describe('basic replacement', () => {
        it('should replace @ mention at end of text', () => {
            ...
            const result = suggestionApply(content, selection, '@john_smith');
        ...
        it('should replace : emoji at end of text', () => {
            ...
            const result = suggestionApply(content, selection, ':happy:');
        ...
        it('should replace / command at end of text', () => {
            ...
            const result = suggestionApply(content, selection, '/help');
    ...
    describe('space handling', () => {
        ...
        it('should respect addSpace parameter when false', () => {
            ...
            const selection = { start: 11, end: 11 };
            const result = suggestionApply(content, selection, '@john_smith', ['@', ':', '/'], false);
    ...
    describe('edge cases', () => {
        ...
        it('should handle multiple words with same prefix', () => {
            ...
            const result = suggestionApply(content, selection, '@alice');
    ...
    describe('custom prefixes', () => {
        it('should work with custom prefixes', () => {
            ...
            const result = suggestionApply(content, selection, '$variable', ['$']);
